		...
		<div class="center-highlight">
			<div class="container">
				...
				<?php if (get_option('deepfocus_blog_style') == 'false') { ?>
					<?php for ($i=1; $i <= 2; $i++) { ?>
						<?php query_posts('page_id=' . get_pageId(html_entity_decode(get_option('deepfocus_home_page_'.$i)))); while (have_posts()) : the_post(); ?>
							<div class="service">
								...
								$more = 0;	
								the_content(''); ?>
								<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('Leer más','DeepFocus'); ?></span></a>
							</div> <!-- end .service -->
					...
					<div class="service" id="blog">
						...
						<div id="blog-wrapper">
							<div id="blog-content">
								...
								<h4 class="widgettitle"><?php esc_html_e('Últimos post del blog','DeepFocus'); ?></h4>
					...
					<h3 class="hometitle recentworks"><?php esc_html_e('Últimas publicaciones','DeepFocus'); ?></h3>
